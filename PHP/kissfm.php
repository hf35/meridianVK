...
$titlelink = 'http://stream.kissfm.ua:8000/kiss';//'http\:\/\/94.25.53.133:80/ultra-192'; //$_REQUEST['url'];
	if ($titlelink == ""):
		echo "";
else:
	...
	//$song = substr_replace($song,"",-18); //str_replace("[ХИТрая музыка]" ,"q",$song); // str_replace("[ХИТрая музыка]","",$song);
	header('Ultra:ok');
	echo $song;
	endif;
