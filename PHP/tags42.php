...
$titlelink = 'http://listen.42fm.ru:8000/stealkill';//'http\:\/\/94.25.53.133:80/ultra-192'; //$_REQUEST['url'];
	if ($titlelink == ""):
		echo "";
else:
	...
	//$song = substr_replace($song,"",-28); //str_replace("[’»“ра€ музыка]" ,"q",$song); // str_replace("[’»“ра€ музыка]","",$song);
	header('Ultra:ok');
	echo $song;
	endif;
